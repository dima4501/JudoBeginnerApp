 ...
 * @author Dima
 */
public class Begginer_Interface extends javax.swing.JFrame {

    /**
     * Creates new form Begginer_Interface
     */
    public Begginer_Interface() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Private Lessons:");
        ...
        jLabel6.setText("The Information");
        ...
        jLabel8.setText("weight Category:");
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(206, 206, 206)
                                                .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 473,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap())
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        int plesson = Integer.parseInt(jTextField4.getText());

        if (plesson > 5)
            JOptionPane.showMessageDialog(null, "You can't take more than 5 Lesson.. Try again");
        else {
            Begginer b1 = new Begginer(name, weight, plesson);
            jTextField5.setText(name);
            jTextField6.setText(b1.cal_weightcategory());
            jTextField8.setText(String.valueOf(b1.calc_cost()));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Begginer_Interface.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Begginer_Interface().setVisible(true);
            }
        });
    }
